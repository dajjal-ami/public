...
# Starting setup
info_message "Starting setup for creator..."
...
folder_name="creator_${random_suffix}"
...
npx pm2 delete creator
npx pm2 start npm --name "creator" -- run start
npx pm2 save
npx pm2 startup
npx pm2 stop creator
